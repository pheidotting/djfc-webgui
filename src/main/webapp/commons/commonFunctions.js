define([ "commons/3rdparty/log",
	...
	return {
		...
		zetDatumTijdOm: function(datumZonderStreepjes){
			var datumMetStreepjes = datumZonderStreepjes.replace(' ', '');
			if(datumZonderStreepjes !== undefined && datumZonderStreepjes !== null && datumZonderStreepjes.length === 12 && this.isNumeric(datumZonderStreepjes)){
